...
const DriversPage = () => {
    ...
    const [formData, setFormData] = useState({
        full_name: '', phone: '', assigned_truck_id: '', employment_status: 'active', photo_url: '', documents: []
    });
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            fetchDrivers();
            setFormData({ full_name: '', phone: '', assigned_truck_id: '', employment_status: 'active', photo_url: '', documents: [] });
        } catch (error) {
